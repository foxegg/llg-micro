package indi.micro.common.mail.utils;
...
import indi.micro.common.utils.SpringUtils;
...
public class MailUtils {
	...
	public static MailAccount getMailAccount(String from, String user, String pass) {
		ACCOUNT.setFrom(StringUtils.nvl(from, ACCOUNT.getFrom()));
		ACCOUNT.setUser(StringUtils.nvl(user, ACCOUNT.getUser()));
		ACCOUNT.setPass(StringUtils.nvl(pass, ACCOUNT.getPass()));
		return ACCOUNT;
	}
