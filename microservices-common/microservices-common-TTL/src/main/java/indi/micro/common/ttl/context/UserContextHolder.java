package indi.micro.common.ttl.context;
...
import indi.micro.common.text.Convert;
...
public class UserContextHolder {
	...
	public static void setUserName(String username) {
		...
		// System.out.println("UserContextHolder 中设置的用户名为：" + username);
	...
	public static void setUserToken(String userKey) {
		set(SecurityConstants.TOKEN, userKey);
	}
