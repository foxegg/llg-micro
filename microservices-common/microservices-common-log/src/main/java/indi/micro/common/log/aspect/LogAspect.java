package indi.micro.common.log.aspect;
...
import indi.micro.common.log.enums.BusinessStatus;
import indi.micro.common.log.annotation.Log;
import indi.micro.common.log.filter.PropertyPreExcludeFilter;
import indi.micro.common.log.service.AsyncLogService;
import indi.micro.common.ttl.util.CurrentUserUtils;
import indi.micro.common.utils.ServletUtils;
import indi.micro.common.utils.StringUtils;
import indi.micro.common.utils.ip.IpUtils;
...
public class LogAspect {
	...
	public void boBefore(Log controllerLog) {
	...
	protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
		...
		try {
			...
			// System.out.println("需要保存到数据库中的操作日志信息为：" + operLog.toString());
